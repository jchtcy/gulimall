...
public class AliPayConfig {
    ...
    public String pay(PayVO vo) throws AlipayApiException {
        ...
        //AlipayClient alipayClient = new DefaultAlipayClient(AlipayTemplate.gatewayUrl, AlipayTemplate.appId, AlipayTemplate.merchantPrivateKey, "json", AlipayTemplate.charset, AlipayTemplate.alipayPublicKey, AlipayTemplate.signType);
        //1、根据支付宝的配置生成一个支付客户端
